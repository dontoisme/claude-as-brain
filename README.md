...
| `/reindex` | Rebuild the deletable retrieval index behind `/ask` | Automatic, via weekly review; by hand after a bulk import |
...
| `/verify` | Refetch the URLs a note's claims rest on | As needed, on notes with `sources:` |
